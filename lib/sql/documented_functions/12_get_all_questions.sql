-- Function Name: get_all_questions
-- Description:
-- المسؤولة عن جلب جميع الأسئلة المجابة (للأدمن أو لعرض عام).
-- تعرض جميع الأسئلة المجابة بدون فلترة حسب المتابعة.
--
-- آلية العمل:
-- 1. تستقبل معرف المستخدم (Text) وتحوله لـ UUID بأمان.
-- 2. تجلب قائمة المحظورين (Block List) لهذا المستخدم لتجنب عرض محتواهم.
-- 3. تقوم بعمل JOIN بين جداول (Questions, Users).
-- 4. تفلتر النتائج:
